...
def save_metadata(dataset_name, split, gridworld):
    ...
    flattened_causals = list(gridworld.causal_vector_to_debug_dict(causal_vector).keys())
...
def gen_data(seeds, batch_size, split, dataset_name='gridworld', grid_x=16, grid_y=16, sprite_size=32, fixed_light_positions=[]):
    ...
    run_simulation(seeds[0], split, dataset_name, grid_x, grid_y, sprite_size, fixed_light_positions, save_metadata_flag=True)
